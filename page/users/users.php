            ...
            <table id="datatable" class="table table-bordered">
              ...
              <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                <tr>
                  ...
                  <td>
                    <a href="?page=users&aksi=foto&id=<?= $row['userid']; ?>" class="btn btn-primary"><i class="fa fa-image"></i></a>
                    <a href="?page=users&aksi=ubah&id=<?= $row['userid']; ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
