                ...
                <tr>
                  ...
                  <td>
                    ...
                    <?php if($row['status_pembayaran'] == 1) { ?>
                      ...
                      <a href="?page=laundry&aksi=detail&id=<?= $row['id_laundry']; ?>" class="btn btn-primary"><i class="fa fa-eye"></i> Detail</a>

                      <a href="page/cetak_transaksi.php?id=<?= $row['id_laundry']; ?>" class="btn btn-secondary" target="_blank"><i class="fa fa-download"> Cetak</i></></a>
