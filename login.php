...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/logoo.jpg" type="image/png"/>
    <title>Login</title>
...
<div class="container">
    <div class="row justify-content-center align-items-center min-vh-100">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                <center><h3 class="text-center mt-0 m-b-15">
                        <h1>Login</h1>
                        <a href="login.php"><img src="assets/images/logoo.jpg" width="200px"></a>
                    </h3>
                    <h4>Laundry.in</h4>
                    <p>To make a laundry transaction, do login first. Enjoy the service</p></center>
